...
class _ReelsEditScreenState extends State<ReelsEditScreen> {
  ...
  void initState() {
    super.initState();
    controller = VideoPlayerController.file(widget.videoFile)..initialize().then((_){
      setState(() {
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      String Reels_Url = await StorageMethod().uploadImageToStorage('Reels', widget.videoFile);
                      await Firebase_Firestorage().CreateReels(video: Reels_Url, caption: caption.text);
